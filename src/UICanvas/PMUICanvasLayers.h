...
public:
    ...
    void bindBehaviour(float *_curveSpeed, float *_curveSize, float *_noiseSpeed, float *_kneeScaleFactor, int *_maxLife, float *_kneesThreshold){
...
private:
    ...
    //Behaviour
    float                     *curveSpeed, *curveSize, *noiseSpeed, *kneeScaleFactor, *kneesThreshold;
	int *maxLife;
